...
def cli_main():
    ...
    if args.profile:
        trainer = pl.Trainer.from_argparse_args(args, strategy=DDPStrategy(find_unused_parameters=True),
                                                profiler=AdvancedProfiler(filename='perf.txt'), logger=logger,
                                                check_val_every_n_epoch=args.check_val_every_n_epoch)
    else:
        trainer = pl.Trainer.from_argparse_args(args, strategy=DDPStrategy(find_unused_parameters=True), logger=logger,
                                                check_val_every_n_epoch=args.check_val_every_n_epoch)
