...
echo "====================================================================="
default_root_dir="../exps/$seed/dense/lap-type"
...
python ../entry.py --num_workers 8 --seed $seed --batch_size $batch_size \
      ...
      --dense_setting \
      --test --save_display \
      --checkpoint_path /home/daya/Desktop/tokengt-main/equivariant-basis-approximation/exps/12/dense/lap-type/checkpoints/last.ckpt\
